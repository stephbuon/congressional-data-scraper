...
### Number of Records 
The 104th Congress onward digitize around 50,000 records each. View the "congress.gov" [search page](https://www.congress.gov/search?q={%22congress%22%3A[%22117%22]%2C%22search%22%3A%22the%22%2C%22source%22%3A%22congrecord%22}) for specifics on how many records make up a specific congressional caucus (or for information about how many records from a caucus contain a keyword). For step-by-step instructions on how to use "congress.gov" to find this information, see the CDS [wiki](https://github.com/stephbuon/congressional-data-scraper/wiki/Number-of-Records-Per-Caucus).
