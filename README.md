Note: We want everyone to have the ability to collect Congressional Records! If you want to use our tool but have never used Python before just watch this [3 minute video]() and you will be ready to go. 
